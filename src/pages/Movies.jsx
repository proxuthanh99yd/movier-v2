...
Movies.propTypes = {
    moviesState: PropTypes.func,
    movies: PropTypes.func,
    moviesFilter: PropTypes.func,
...
export default function Movies({
    ...
    useEffect(() => {
        if (filterStatus) {
            ...
            dispatch(moviesFilter({ ...filter, sort }));
        } else {
    ...
    return (
        <>
            <Breadcrumb
                ...
                image={moviesNowPlaying[0]?.backdrop_path}
            />
            <Wrapper>
